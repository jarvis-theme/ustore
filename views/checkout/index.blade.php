 <section class="wrapper">
  <div id="container">
    ...
    <div id="content">
      ...
      <div class="breadcrumb"> <a href="{{URL::to('')}}">Home</a> » Shopping Cart</div>
      <!--Breadcrumb Part End-->
      <h1>Shopping Cart</h1>
      @if($cart->contents())
      <div class="cart-info">
          ...
          <tbody>
            ...
            <tr id="cart{{$item['rowid']}}">
              ...
              <td class="quantity">
                ...
                &nbsp;
                <input type="image" title="hapus" alt="hapus" onclick="deletecart('{{$item["rowid"]}}')" src="{{URL::to('themes/ustore/assets/images/remove.png')}}">
              </td>
        ...
        <table id="total">
          <tbody>
            ...
            <tr>
              ...
              <td class="right"><span id='kupontext'>{{jadiRupiah(0)}}</span></td>
            </tr>              
            <tr>
      ...
      <div class="buttons">
        ...
        <div class="left"><a class="button" href="{{URL::to('produk')}}">Continue Shopping</a></div>
      </div>         
      @else
      <div class="buttons">
        <div class="center">
          <h2>Maaf, tapi keranjang belanja anda masih kosong?</h2><br>
          <a class="button" href="{{URL::to('produk')}}">Continue Shopping</a>
        </div>
      </div>
      @endif
    </div>
