    ...
    <div id="content">
      ...
      <div class="breadcrumb"><a href="{{url('home')}}">Home</a> » <a href="{{url('checkout')}}">Shopping Cart</a> » Finish</div>
      <!--Breadcrumb Part End-->
    ...
    <div class="checkout">
      <div class="content">
        ...
        <h3>ID ORDER: {{$pengaturan->invoice}}{{$order->kodeOrder}}</h3>Total Harga Belanjaan: {{price($order->total)}}<hr>
        ...
        @if($datapembayaran=='1')
          ...
          <hr>
          <p>Setelah melakukan pembayaran anda bisa mengkonfirmasi pembayaran anda disini: <a href="{{url('konfirmasiorder/'.$order->id)}}" class="btn theme">Konfirmasi Pembayaran</a></p>
        @endif
